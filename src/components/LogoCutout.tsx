...
export const LogoCutout: React.FC<LogoCutoutProps> = ({ src, alt = "Logo", className }) => {
  return (
    <div className={cn("relative inline-block overflow-hidden", className)}>
      ...
      <div
        className="absolute inset-[1px] bg-[linear-gradient(90deg,hsl(var(--primary)),hsl(var(--secondary)),hsl(var(--primary)))] bg-[length:300%_100%] animate-gradient-shift pointer-events-none"
        aria-hidden="true"
      />
