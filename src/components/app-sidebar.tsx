      ...
      <SidebarContent className="bg-card border-r border-border/30 shadow-2xl">
        ...
        {!isCollapsed && (
          <div className="p-4 border-b border-border/30">
            <CyberButton variant="outline" size="sm" className="w-fit justify-center mx-2 bg-gradient-to-r from-blue-600 to-cyan-400 border-0 text-white hover:from-blue-700 hover:to-cyan-500">
