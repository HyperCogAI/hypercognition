      ...
      <SidebarContent className="bg-card border-r border-border/30 shadow-2xl">
        ...
        {!isCollapsed && (
          <div className="p-4 border-b border-border/30">
            <div className="px-2.5 py-1.5 rounded-lg transition-all duration-300 hover:bg-background hover:text-foreground text-muted-foreground flex items-center gap-2.5 group cursor-pointer border border-primary/30 hover:border-primary/50 w-fit text-sm">
