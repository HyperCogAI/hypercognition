                ...
                <SidebarMenuItem key={item.title}>
                  <SidebarMenuButton asChild isActive={isActive(item.url)}>
                    ...
                    >
                      {({ isActive }) => (
                        <>
                          <item.icon className={`h-4 w-4 opacity-100 group-hover/menu:scale-110 transition-all duration-300`} strokeWidth={2.3} />
                ...
                <SidebarMenuItem key={item.title}>
                  <SidebarMenuButton asChild isActive={isActive(item.url)}>
                    ...
                    >
                      {({ isActive }) => (
                        <>
                          <item.icon className={`h-4 w-4 opacity-100 group-hover/menu:scale-110 transition-all duration-300`} strokeWidth={item.icon === TelegramIcon ? undefined : 2.3} />
                          {!isCollapsed && <span className="font-medium">{item.title}</span>}
                        </>
                      )}
                    </NavLink>
                ...
                <SidebarMenuItem key={item.title}>
                  <SidebarMenuButton asChild isActive={isActive(item.url)}>
                    ...
                    >
                      {({ isActive }) => (
                        <>
                          <item.icon className={`h-4 w-4 opacity-100 group-hover/menu:scale-110 transition-all duration-300`} strokeWidth={item.icon === SolanaLogo ? undefined : 2.3} />
                          {!isCollapsed && <span className="font-medium">{item.title}</span>}
                        </>
                      )}
                    </NavLink>
                ...
                <SidebarMenuItem key={item.title}>
                  <SidebarMenuButton asChild isActive={isActive(item.url)}>
                    {item.external ? (
                      ...
                      >
                        <item.icon className="h-4 w-4 opacity-100 group-hover/menu:scale-110 transition-all duration-300" strokeWidth={2.3} stroke="currentColor" fill="none" />
                        {!isCollapsed && (
                          <div className="flex items-center justify-between w-full">
                            <span className="font-medium">{item.title}</span>
                            <ExternalLink className="h-3 w-3 opacity-100 transition-all duration-300 group-hover/menu:scale-110" strokeWidth={2.3} />
                          </div>
                        )}
                      </a>
                    ) : (
                ...
                <SidebarMenuItem>
                  <SidebarMenuButton asChild isActive={isActive('/settings')}>
                    ...
                    >
                      {({ isActive }) => (
                        <>
                          <Settings className="h-4 w-4 opacity-100 group-hover/menu:rotate-90 transition-all duration-300" strokeWidth={2.3} />
