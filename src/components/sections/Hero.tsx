  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 bottom-0 z-0 flex items-start justify-center -mt-96 md:-mt-96 lg:-mt-96">
        <OptimizedVideo
          src={heroVideo}
          className="w-full h-full max-w-full max-h-full object-contain opacity-90 transform -translate-y-96 md:translate-y-0"
          autoPlay
          loop
          muted
          playsInline
      ...
      <div className="relative z-20 container mx-auto px-6 text-center">
        <div className="max-w-4xl mx-auto space-y-8 animate-fade-up pt-[34rem]">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <CyberButton variant="neon" size="xl" className="group md:text-xs">
            ...
            <CyberButton variant="analytics" size="xl" className="group md:text-xs">
