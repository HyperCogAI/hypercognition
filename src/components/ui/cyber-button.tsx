  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        "gradient-border": "bg-black/60 text-white border border-transparent hover:bg-black/70 transition-all duration-300 [background-clip:padding-box] [border-image:linear-gradient(90deg,hsl(var(--primary)),hsl(var(--secondary)),hsl(var(--primary)))_1] animate-[borderRotate_3s_linear_infinite] bg-[length:200%_100%]"
      },
      size: {
