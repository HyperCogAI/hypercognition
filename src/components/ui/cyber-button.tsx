...
const cyberButtonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary/90 text-primary-foreground shadow hover:bg-primary hover:text-muted-foreground transition-all duration-300",
        ...
        neon: "bg-secondary text-white hover:bg-secondary/90 hover:text-muted-foreground transition-all duration-300 shadow-lg glow-secondary",
