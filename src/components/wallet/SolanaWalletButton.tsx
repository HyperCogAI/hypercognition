    ...
    if (inIframe) {
      ...
      return (
        <div className="w-full flex flex-col gap-2">
          <div className="relative rounded-full w-[130px] p-[4px] bg-[linear-gradient(90deg,hsl(var(--primary)),hsl(var(--secondary)),hsl(var(--primary)))] bg-[length:300%_100%] animate-gradient-shift shadow-[0_0_12px_hsl(var(--primary)/0.35)]">
