-- Fix the tutorials table structure
ALTER TABLE public.tutorials ALTER COLUMN id TYPE UUID USING gen_random_uuid();
ALTER TABLE public.tutorials ALTER COLUMN id SET DEFAULT gen_random_uuid();
